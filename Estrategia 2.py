...
delta_t = 0.01 # [s]
Avance = 10 #avance en la dirección z
V_FACTOR = 0.0002 #velocidad (no subir mucho)
...
while True:
    ...
    if pos.Norm() != 0.0:
        ...
        base_axis = H_base_tcp.M * tcp_axis * V_FACTOR

        #TRANSLACIÓN
        p_base = H_base_tcp * PyKDL.Vector(0, 0, Avance)  #avance en posición respecto a la base

        # hago la cinemática inversa para velocidad
        v = PyKDL.Twist(p_base-H_base_tcp.p, base_axis)
